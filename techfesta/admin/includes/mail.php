				...
				<div class="nano-content">
					...
					<div class="inner-menu-content">
						...
						<ul class="list-unstyled mt-xl pt-md">
							<li>
								<a href="mailbox-folder" class="menu-item active">Inbox <span class="label label-primary text-normal pull-right"></span></a>
							</li>
							<li>
								<a href="mailbox-folder" class="menu-item">Important</a>
							</li>
							<li>
								<a href="mailbox-folder" class="menu-item">Sent</a>
							</li>
							<li>
								<a href="mailbox-folder" class="menu-item">Drafts</a>
							</li>
							<li>
								<a href="mailbox-folder" class="menu-item">Trash</a>
							</li>
						</ul>
					</div>
				</div>
