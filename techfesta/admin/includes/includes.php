...
// } else {
// 	header("Location: /techfesta/home.php");
// }

$sql1 = "SELECT * FROM admin";

$admin = $start->query($sql1);
// $admin->num_row;
$ad = $admin->fetch_assoc();
?>
        ...
        <div id="userbox" class="userbox">
            ...
            <div class="dropdown-menu">
                <ul class="list-unstyled">
                    ...
                    <li>
                        <a role="menuitem" tabindex="-1" href="/techfesta/admin/logout"><i class="fa fa-power-off"></i> Logout</a>
                    </li>
                </ul>
            </div>
        </div>
