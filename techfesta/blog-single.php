...
<div class="navbar navbar-default navbar-static-top" role="navigation">
	<div class="container">
		...
		<div class="navbar-header">
			...
			<a href="/techfesta/index.php" class="navbar-brand">Fitness</a>
		</div>
		<div class="collapse navbar-collapse">
			<ul class="nav navbar-nav navbar-right">
				<li><a href="index.php#home" class="smoothScroll">Home</a></li>
				<li><a href="index.php#overview" class="smoothScroll">About</a></li>
				<li><a href="index.php#trainer" class="smoothScroll">Trainers</a></li>
			</ul>
		</div>
...
<!-- =========================
    BLOG HEADER SECTION   
============================== -->
<section id="blog-header" style="background: linear-gradient(rgba(0,0,0,.7), rgba(0,0,0,.5)),url('images/blog-header-bg2.jpg') 0 repeat-y fixed;" class="parallax-section">
	<div class="container">
		<div class="row">
			...
			<div class="col-md-8 col-sm-7">
				...
				<div class="blog-comment-form wow fadeInUp" data-wow-delay="1s">
					<h3>Leave a comment</h3>
						<form action="/techfesta/comments.php" method="post" id="comment-form">
