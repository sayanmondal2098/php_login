...
if(isset($_POST['submit'])){
	...
	if($Pass == $Confirm){
		$Password = $_POST['pwd'];
		$Query = "INSERT INTO package_3 (Name, Email, Password) VALUES ('$Name', '$Email', '$Password')";
				...
				<div class="panel panel-sign">
					...
					<div class="panel-body">
						<form action="" method="POST">
							...
							<p class="text-center">Already have an account? <a href="/techfesta/login_pack3.php">Sign In!</a>
